  ...
  useEffect(() => {
    ...
    if (token.startsWith('b64_')) {
      try {
        ...
        setData({ project: { name: d.n, client: d.c, location: d.l, startDate: d.s, phases: d.ph||[], avize: d.av||[], type: d.t||'arhitectura', clientNote: d.note||'' }, config: d.cfg || {} })
      } catch { setErr('Link invalid.') }
      return
    }
